...
# Thanks to https://github.com/Barbarossa93/Genome/blob/main/.local/bin/rofi_notif_center.sh for the majority of this script

##### Useful settings #####

# Directory to search for icons
directory="/usr/share/icons/Sardi-Ghost-Flexible-Viking/"
